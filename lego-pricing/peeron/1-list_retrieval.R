# We're going to get all the parts lists for all the lego sets from the site toypro.com
# Here's a sample URL: http://www.toypro.com/en/set/parts?list=big&itemid=10241&fitems=200
# 
# Here's a different list: http://guide.lugnet.com/set/?qc=lego&v=c&qn=7900
